...
## tests for Inline 2.0
wilcox.test(df1$ATS~df1$Test_Type, conf.level=0.05) # 0.005932 significant
t.test(log(df1$ATS)~df1$Test_Type, conf.level=0.05, var.equal=FALSE) # 0.08684 significant
kruskal.test(ATS~Test_Type, data=df1) # 0.005932 significant
