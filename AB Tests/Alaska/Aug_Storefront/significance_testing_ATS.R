...
setwd("C:/Users/kelvin.ye/workplace/data-wizards/AB Tests/Alaska/Aug_Storefront")
...
wilcox.test(df1$ATS~df1$Test_Type, conf.level=0.05) # 0.6603 not significant
t.test(log(df1$ATS)~df1$Test_Type, conf.level=0.05, var.equal=FALSE) # 0.5407 not significant
kruskal.test(ATS~Test_Type, data=df1) # 0.6602 not significant
